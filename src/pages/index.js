...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section
			padding="140px 0"
			sm-padding="40px 0"
			background="linear-gradient(0deg,rgba(0,0,0,0.5) 0%,rgba(0,0,0,.2) 100%),--color-dark url(https://images.unsplash.com/photo-1624378804433-656379d28147?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&w=2000) 50% 15%/cover"
			color="--light"
			font="--base"
